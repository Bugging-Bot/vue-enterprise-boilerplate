...
const rhombus1 = new ShapeFactory({
  position: { x: 250, y: 87 },
...
const rhombus2 = new ShapeFactory({
...
const Balance1 = new ShapeFactory({
...
const Balance2 = new ShapeFactory({
...
const Balance3 = new ShapeFactory({
...
const Container0 = new ShapeFactory({
  position: { x: 50, y: 250 },
...
const Container1 = new ShapeFactory({
  position: { x: 870, y: 70 },
  size: { width: ContainerSize.width, height: ContainerSize.height }, //custom size of shape, but this changes the position of label
  svgPath: 'M4.6 5.07L4.6 62L69.4 62L69.4 5.07M1 9.13L1 1L73 1L73 9.13',
  fill: '#fcf3cf',
...
const Container2 = new ShapeFactory({
...
const Container3 = new ShapeFactory({
...
const Container4 = new ShapeFactory({
...
const Container5 = new ShapeFactory({
...
const FContainer1 = new ShapeFactory({
...
const FContainer2 = new ShapeFactory({
  position: { x: 60, y: 370 },
  size: { width: FContainerSize.width, height: FContainerSize.height }, //custom size of shape, but this changes the position of label
  svgPath: 'M1 1L45 1L45 32.67L23 48.5L1 32.67ZM16.4 13.47C20.41 11.59 25.59 11.59 29.6 13.47',
  fill: '#fcf3cf',
...
const funnel1 = new ShapeFactory({
...
const funnel2 = new ShapeFactory({
...
const funnel3 = new ShapeFactory({
...
const funnel4 = new ShapeFactory({
...
const ShapeLoof = new ShapeFactory({
...
const temperature1 = new ShapeFactory({
  position: { x: 170, y: 55 },
...
const temperature2 = new ShapeFactory({
...
const temperature3 = new ShapeFactory({
...
const temperature4 = new ShapeFactory({
...
const temperature5 = new ShapeFactory({
...
const temperature6 = new ShapeFactory({
...
const temperature7 = new ShapeFactory({
...
const link30 = new shapes.standard.Link({
  linkID: 'Mouldy->clock',
  source: { id: rhombus1.id },
  target: { id: clock1.id },
  attrs: {
