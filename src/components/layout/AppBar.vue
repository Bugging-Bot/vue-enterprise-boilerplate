...
// Export the SCSS variable as a CSS custom property
.layerPageZIndex {
  z-index: $layer-page-z-index;
} -->
// .app-bar { // display: flex; // align-items: center; // height: 48px; /* Reduce the height */ //
min-height: 48px; /*Ensure it doesn't stretch */ // /*box-shadow: none; /* Remove the shadow */ //
/* border: 1px solid var(--primary-color);*/ /* Add a border for debugging only*/ // box-sizing:
border-box; /* Add this to include borders in the element's dimensions */ // } // .app-bar__nav { //
display: flex; // align-items: center; // /* border: 1px solid blue; Add a border for debugging only
*/ // /* border-color: var(--info-color); */ // padding: 0px 0px; /* Add padding for better spacing
*/ // height: 46px; /* Reduce the height */ // min-height: 46px; /*Ensure it doesn't stretch */ //
box-sizing: border-box; // } // .app-bar__search { // width: auto; // transition: all 0.3s ease; //
/* border: 1px solid green; Add a border for debugging only */ // box-sizing: border-box; // } //
.app-bar__search--active { // flex-grow: 1; // max-width: 600px; // margin: 0 16px; // padding: 0px
0px; /* Padding for better spacing when search is active */ // box-sizing: border-box; // } //
.app-bar__search-field { // width: 100%; // } // .app-bar__actions { // display: flex; //
align-items: center; // gap: 8px; // /* border: 1px solid orange; Add a border for debugging only */
// padding: 0px 0px; /* Add padding to the action buttons */ // height: 46px; /* Reduce the height
*/ // min-height: 46px; /*Ensure it doesn't stretch */ // box-sizing: border-box; // }
<!-- </style> -->
