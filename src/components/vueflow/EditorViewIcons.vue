<!--
  File: EditorViewIcons.vue

  About:
  This component renders different SVG icons based on the provided `name` prop.
  Icons include: 'reset', 'update', 'sun', 'moon', and 'log'.
-->

<script setup>
// Define the `name` prop to determine which icon to render
defineProps({
  name: {
    type: String,
    required: true
